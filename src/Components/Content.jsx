                    ...
                    <div className=' w-[100%]  bg-white flex flex-col justify-center px-4 mx-auto'>
                        <div className='  mt-6 bg-hite px-2 ml-4'>
                            ...
                            <div className='grid grid-cols-2 mt-2 py-2 '>
                                <div>
                                    <p className='text-xs text-gray-500'>Total CryptoCurrencies</p>
                                    <p className='font-medium text-xl'>{millify(globalStat?.total)}</p>
                                </div>
                                <div>
                                    <p className='text-xs text-gray-500' >Total Exchanges</p>

                                    <p className='font-medium text-xl'>{millify(globalStat?.totalExchanges)}</p>
                                </div>
                                <div>
                                    <p className='text-xs text-gray-500'>Total Market Cap</p>

                                    <p className='font-medium text-xl'>{millify(globalStat?.totalMarketCap)}</p>
                                </div>
                                <div>
                                    <p className='text-xs text-gray-500'>Total 24h volume</p>

                                    <p className='font-medium text-xl'>{millify(globalStat?.total24hVolume)}</p>
                                </div>
                                <div>
                                    <p className='text-xs text-gray-500'>Total MArkets</p>

                                    <p className='font-medium text-xl'>{millify(globalStat?.totalMarkets)}</p>
                                </div>
                            </div>
                        </div>
                    </div>
